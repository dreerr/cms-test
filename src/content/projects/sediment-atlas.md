---
title: Sediment Atlas
sort: 2
year: 2023
tagline: Geological time encoded in layered ceramic glazes
tags:
  - data visualisation
  - print
  - ceramics
summary: A series of 48 large-format ceramic tiles whose glazes encode soil
  composition data from bore samples taken at 5-kilometre intervals across the
  Danube floodplain.
gallery:
  - type: image
    src: /uploads/sediment-atlas/tiles-installation.svg
    caption: Full installation, 48 tiles, Kunsthalle Wien, 2023
  - type: image
    src: /uploads/sediment-atlas/glaze-detail.svg
    caption: Glaze detail showing iron and clay strata
  - type: image
    src: /uploads/sediment-atlas/bore-sample.svg
    caption: Reference bore sample, km 42, Donauauen
  - type: image
    src: /uploads/sediment-atlas/studio-process.svg
    caption: Glaze mixing in studio, cross-referencing spectrometry data
  - type: image
    src: /uploads/receive.webp
    caption: Recieve
---
